...
public class FirebaseServices {
    ...
    private static void initFirebase() {
        ...
        try {
            ...
            File file = new File("C:\\Users\\adria_6\\OneDrive\\Documentos\\NetBeansProjects\\ChessApp\\src\\resources\\chessApp-key-json.json");
            if (!file.exists()) {
            ...
            FirebaseOptions firebaseOptions = new FirebaseOptions.Builder()
                    .setCredentials(GoogleCredentials.fromStream(new FileInputStream("C:\\Users\\adria_6\\OneDrive\\Documentos\\NetBeansProjects\\ChessApp\\src\\resources\\chessApp-key-json.json")))
